...
const PATTERN = new RegExp(`(?:il\\s{0,3})?` +
...
const YEAR_GROUP = 4;
class ITMonthNameLittleEndianParser extends AbstractParserWithWordBoundary_1.AbstractParserWithWordBoundaryChecking {
    innerPattern() {
        return PATTERN;
    }
...
exports.default = ITMonthNameLittleEndianParser;
